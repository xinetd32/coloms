...
Ext.define('coloMS.controller.Options', {
    ...
    init: function() {
        this.listen({
            controller: {},
            component: {
                'grid[xtype=options.List]': {
                    edit: this.save,
                    canceledit: this.cancel,
                    beforerender: this.loadRecords,
                    itemcontextmenu: this.showContextMenu
                },
                'grid[xtype=options.List] button#add': {
                    click: this.add
                },
                'grid[xtype=options.List] gridview': {
                    itemadd: this.edit
                }
            },
            global: {},
